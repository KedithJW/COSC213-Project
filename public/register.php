...
/*
    ...
    Testing registration page, connects to database and adds user info if valid, but i never actually got a chance to test the connecting to a database part. Couldnt figure out how to set one up on my local machine
